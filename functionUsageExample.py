...
def start():
	...
	train = trainSample(vocabFile="/media/compute/homes/mdelvecchio/bert_pretrained_tensorflow/base_uncased/vocab.txt", modelWeights="/media/compute/homes/mdelvecchio/bert_pretrained_tensorflow/base_uncased/bert_model.ckpt", trainFile="/media/compute/homes/mdelvecchio/squad_bak/v1.1/train-v1.1.json", predictFile="/media/compute/homes/mdelvecchio/squad_bak/v1.1/dev-v1.1.json", useTFCheckpoint=True, doTrain=True, doPredict=True, trainEpochs=6.0, trainBatchSize=12, maxSeqLength=512, useVer2=False, doLowercase=True, bertTrainable=True, useDebug=True, model="QABERT4LGELUSkip")
